...
Proof.
  intros n m p. induction n as [| n' IHn'].
   - simpl. reflexivity.
   - simpl. rewrite plus_comm. rewrite plus_comm. rewrite <- IHn'. reflexivity. Qed.
(** [] *)
...
Theorem plus_swap : forall n m p : nat,
  n + (m + p) = m + (n + p).
Proof.
  intros n m p. simpl. rewrite plus_assoc.
  assert (n + m = m + n).
    rewrite <- plus_comm. reflexivity.
...
Theorem helper: forall n m :nat  ,
 m * S n = m + m *n.
 Proof.
   intros n m. induction m as [|m'].
   - simpl.  reflexivity.
   - simpl. rewrite IHm'. simpl. rewrite  plus_swap. reflexivity. Qed.
...
Proof.
  ...
  - simpl. rewrite helper. rewrite IHn'. reflexivity. Qed.
(** [] *)
